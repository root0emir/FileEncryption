...
class FileEncryptor(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Dosya Şifreleme Aracı")
    ...
    def encrypt_file(self):
        ...
        else:  # Anahtar girilmediyse, yeni bir anahtar üret
    ...
    def decrypt_file(self):
        ...
        # Şifreli dosyanın .enc uzantısı ile bitip bitmediğini kontrol et
